...
@.str.2 = private unnamed_addr constant [25 x i8] c"\44\69\67\69\74\65\20\75\6D\20\76\61\6C\6F\72\20\70\61\72\61\20\62\3A\0A\00", align 1
@.str.3 = private unnamed_addr constant [4 x i8] c"\25\64\0A\00", align 1
...
entry:
    ...
    %temp0 = getelementptr inbounds [25 x i8], [25 x i8]* @.str.0, i64 0, i64 0
    ...
    %temp4 = getelementptr inbounds [25 x i8], [25 x i8]* @.str.2, i64 0, i64 0
    ...
    %temp11 = getelementptr inbounds [4 x i8], [4 x i8]* @.str.3, i64 0, i64 0
    %temp12 = call i32 (i8*, ...) @printf(i8* %temp11, i32 %temp10)
    ret i32 0
}